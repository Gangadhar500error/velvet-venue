...
VENDOR_PERMISSIONS = [
    ...
    CUSTOMER_VIEW.code, CUSTOMER_CREATE.code, CUSTOMER_UPDATE.code,
    ...
    VENDOR_VIEW.code, VENDOR_UPDATE.code,
]

CUSTOMER_PERMISSIONS = [
    DASHBOARD_VIEW.code,
    VENUE_VIEW.code, AVAILABILITY_VIEW.code,
    ...
    NOTIFICATION_VIEW.code,
    PROFILE_VIEW.code, PROFILE_UPDATE.code,
    CUSTOMER_VIEW.code, CUSTOMER_UPDATE.code,
]
